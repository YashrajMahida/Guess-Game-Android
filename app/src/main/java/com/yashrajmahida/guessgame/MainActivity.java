package com.yashrajmahida.guessgame;
...
public class MainActivity extends AppCompatActivity {
    ...
    public void checkGuess(View view){
        ...
        if(guessedNumberInt > randomNumber){
            ...
            Toast.makeText(getApplicationContext(), "You guessed way too high!!", Toast.LENGTH_LONG).show();

        }else if(guessedNumberInt < randomNumber){

            message = "You guessed way too low!!";

        }else{

            message = "You're great !! You guessed right!!";
